...
// Seed-management verbs (mngenerate / mnimport / seedimport / clearseed)
// previously lived here; they were removed in favour of the top-level
// `seed` console command which routes through bao-seed directly.
...
impl<'a> ShellCmdApi<'a> for Eth {
    ...
    fn process(&mut self, args: String, _env: &mut CommonEnv) -> Result<Option<String>, xous::Error> {
        ...
        let helpstring = "eth [config|address|accounts|signmsg|sign|gentx|dangerous]";
